...
})(window,document,'script','dataLayer','GTM-5LRMWG6R');</script>
<!-- End Google Tag Manager -->
   ...
   <body data-spy="scroll" data-target=".navbar" data-offset="120">
       ...
       <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
               ...
               <div class="col-md-9">
                 <div class="collapse navbar-collapse w-100 py-1 justify-content-end" id="navbarResponsive">
                   <ul class="navbar-nav">
                     ...
                     <li>
                       <a class="nav-link" href="#mitid">About</a>
                     </li>
         ...
         <div class="w-100 d-lg-none">
           <a class="navbar-brand pl-2 d-lg-none d-inline-block" href="#">
             <img alt="logo"
               data-src="img/logo/1.webp"
               class="img-fluid lazyload" style="width: 180px !important;padding: 8px 0px;">
           </a>
     ...
     <div class="hero-section position-relative">
       ...
       <div class="form_01" style="top:0;">
         <div class="formdekstopmt mar-t pt-4" id="applynow">
           <div align="center">
             <span
               style="font-size:18px;background-color:#9e1b35;padding:0px 10px;font-weight: 800;color: white;">Admissions Open 2026</span>
         ...
         <div class="row">
           ...
           <div class="col-md-7 wow fadeInLeft animated" data-wow-duration="1.2s">
             <div class="programmeme_detl">
               <h3 class="title1" id="mitid">About DPU, <br><span>Dr. D. Y. Patil School of Design</span></h3>
           ...
           <div class="three-cols__columns" data-column-hl="0">
             ...
             <div class="column card-light highlight "
               ...
               <div class="column__wrapper" style="color:#fff">
                 <div class="column__title" data-card-title style="margin-top:20px;color:#fff">WHY DPU, Dr. D. Y. Patil School of
                   Design</div>
                 ...
                 <div class="column__description" style="color:#fff">
                   <ol style="color:#fff">
                     ...
                     <li>Live projects and internship</li>
               ...
               <div class="column__wrapper">
                 ...
                 <div class="column__description text-light whydesignsec">
                   <ul>
                     ...
                     <li>ISO 9001:2015 14001:2015 Certified University</li>
             ...
             <div class="column card-dark" id="scholarships" data-card-color-title="#002855" data-card>
               ...
               <div class="column__wrapper">
                 <div class="column__title"
                   style="color:#fff; text-align: center;font-size:2.5rem !important;margin-top:1rem;"
                   data-card-title>DPU 2026</div>

                 <div class="column__description"
                   style="color:#fff; text-align: center;font-size: 2rem;margin-top: -1.5rem;">UI/UX | Product Design</div>
     ...
     <section class="py-3 py-md-5 placements" id="placement">
       <div class="container">
         <div class="row">
           <div class="col-md-12 text-center wow fadeInUp animated" data-wow-duration="1.3s">
             <h3 class="title1 text-light text-center">Placements & Recruiters</h3>

           </div>
         </div>
         <div class="row">
           <div class="col-md-8 mx-auto text-center">
             <!--   <h5 class="font-weight-bold text-light text_blue  wow zoomIn animated" data-wow-duration="1.3s">Career Statistics @ MIT ID</h5>-->

             <div class="row mx-auto mt-3 my-3">
               <div class="col-md-6 ">
                 <h2 class="mb-lg-3 mb-1"> 300+</h2>
                 <h6 class="text-light" style="padding-bottom: 15px;">Recuriters on Board</h6>
               </div>
               <div class="col-md-6">
                 <h2 class="mb-lg-3 mb-1">520+</h2>
                 <h6 class="text-light" style="padding-bottom: 15px;">Total Number Of Drives At University</h6>
               </div>
             </div>
           </div>
           <div class="clearfix"></div>
