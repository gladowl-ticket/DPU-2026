...
<head>
    <meta charset="utf-8">
    <title>DPU School of Design, Pune — BSc in Animation & VFX Design. Train under industry experts and craft visuals that captivate screens worldwide. Apply now for 2026 admissions.</title>
  ...
  <div class="container">
    ...
    <div class="row flex-wrap-reverse mt-5 pt-lg-3 pt-1 align-items-center">
        ...
        <div class="col-lg-6 pr-lg-5 pt-lg-1 pt-1" id="about">
          ...
          <p align="justify">The B.Sc. (Hons.) in Animation and VFX Design at DPU School of Design prepares students to become storytellers and visual creators ready for the worlds of entertainment, gaming, advertising, and digital media. With advanced tools, experienced faculty, and industry-aligned training, the school stands among the best VFX institutes in India for future-ready creators.<br><br>The curriculum blends artistic foundations with cutting-edge software, helping students turn imagination into powerful visual narratives. Key learning areas include 2D & 3D Animation, Character Design & Rigging, Motion Graphics, VFX Fundamentals, Compositing, Storyboarding, Lighting & Rendering, Digital Illustration, Game Asset Creation, and Post-Production Techniques.</p>
        ...
        <div class="container">
            <div class="row  py-4 justify-content-center">
                <div class="col-lg-8 mb-4 text-center">
                    <h3 class="h2">India's Future Animators Start Somewhere. Start Here.</h3>
                    <p>A program built for creators who think in motion and dream in frames.</p>
