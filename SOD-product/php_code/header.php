        ...
        <div class="container px-0">
            <nav class="navbar navbar-expand-lg  navbar-light p-lg-0">
                <a href="" class="navbar-brand">
                    <img src="img/logo/1.webp" class="hero_logo_01 rounded-3" loading="lazy" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="#Program" class="nav-item nav-link">Programs</a>
                        <a href="#why-choose" class="nav-item nav-link">Get Inspired</a>
                        <a href="#recruiters" class="nav-item nav-link">Industry Interface</a>
                        <a href="#success-stories" class="nav-item nav-link">Expressions</a>
