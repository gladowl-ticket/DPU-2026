...
<head>
    <meta charset="utf-8">
    <title>DPU School of Design, Pune — B.Des & M.Des in Communication Design. Train under industry experts and craft
        compelling visuals that communicate, influence and inspire. Apply now for 2026 admissions.</title>
                    ...
                    <div class="col-lg-3 col-6 d-grid">
                        <div class="d-flex align-items-stretch  justify-content-center  usp_01">
                            <div class="text-center">
                                <h6 class="fw-bold py-2 mb-0 h1 display-4">2023</h6>
                                <p class="pb-0 h5 ">Best Curriculum Award by ASSOCHAM</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6 d-grid">
                        <div class="d-flex align-items-stretch  justify-content-center  usp_01">
                            <div class="text-center">
                                <h6 class="fw-bold py-2 mb-0 h1 display-4">71<sup>rd</sup></h6>
                        ...
                        <div class="middle-box h-100 text-white d-flex align-items-center py-2">
                            <div class="overlay-content">
                                ...
                                <ul class="list-unstyled mt-3">
                                    ...
                                    <li>› In-House Faculty comes seeded Institutes in Design to spearhead the courses
                                    </li>
