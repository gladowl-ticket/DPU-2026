...
<head>
    <meta charset="utf-8">
    <title>DPU School of Design, Pune — B.Des & BSc in Interior Design. Train under industry experts and design spaces that are functional, beautiful and built to inspire. Apply now for 2026 admissions.</title>
        ...
        <div class="position-relative mt-001" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="col-lg-4 pt-5 mt-3  p-3 d-lg-none">
                <div class="border-red rounded-3 text-center bg-white">
                    <img src="img/logo/2.webp" class="hero_logo_01 mt-50 bg-white border rounded-3" loading="lazy"
                        alt="">
                    <div class="">
    ...
    <div class="overflow-hidden">
        ...
        <section class="" id="about-us">
            <div class="container bg-white  rounded-3 pt-5">
                <div class="row px-3">
                    <div class="col-lg-8 align-items-center">
                        <div class="">
                            ...
                            <p align="justify" class="">Established in 2022, DPU | Dr. D. Y. Patil School of Design
                                enriches
                                the legacy of Dr. D. Y. Patil Vidyapeeth, Pune, with a focus on exceptional design
                                education. Our programs empower students to creatively solve real-world design
                                challenges by
                                blending innovation, technical skill, and design empathy. We offer an AICTE-approved
                                Bachelor of Design with specializations in Fashion Design, Communication Design,
                                Interior
                                Spatial & Furniture, Product Design, UX Design and Animation, and VFX Design. Supported
                                by
                                cutting-edge facilities and guided by experts from premier institutes like NID and IIT,
                                our
                        ...
                        <div class="">
                            ...
                            <p align="justify" class="">The beginning in 2000, Dr. D. Y. Patil Vidyapeeth, Pimpri, Pune
                                (DPU) was established under the leadership of the great visionary and philanthropist,
                                Dr. D.
                                ...
                                Initially, it had a humble beginning with only one institute under its fold i.e. Dr. D.
                                Y.
                                Patil Medical, College & Research Centre. The Institute started as a Centre of
                                Excellence
                                with emphasis on medical education, research and healthcare. Within a short span of
                                time,
                    ...
                    <div class="col-lg-4 ps-lg-5 d-none d-lg-grid">
                        <div class="border-red rounded-3 text-center bg-white p-3">
                            <img src="img/logo/2.webp" class="hero_logo_01 mt-50 bg-white border rounded-3"
                                loading="lazy" alt="">
                            <div class="">
                                <div class="border-bottom-01 mx-2">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <h2 class="mb-lg-3 mb-0 display-5 fw-bold title">Awards and <span class="text-red">Ranks</span>
                        </h2>
                    ...
                    <div class="col-lg-4 bg-blue pt-2">
                        <div class="left-box h-100 overlay-content">
                            ...
                            <ul class="list-unstyled mt-4">
                                <li class="d-flex align-items-top"><span>1</span>Foundation year for basics of Design
                                </li>
                                <li class="d-flex align-items-top"><span>2</span>Choice Based Elective Subjects as per
                                    your
                                    specialization</li>
                                ...
                                <li class="d-flex align-items-top"><span>5</span>Live Projects, Graduate Projects,
                                    Design
                                    Collection</li>
                ...
                <div class="row justify-content-center company">
                    ...
                    <div class="row py-3 py-lg-0 justify-content-center text-center m-auto">
                        ...
                        <div class="col-lg-3 col-6 mb-3 mb-lg-0 company_01  ">
                            <img src="img/excellence/<?= $p2[$i];?>.webp" loading="lazy" class="border w-100" alt="">
                        </div>
                        <?php } ?>
                    </div>
                </div>
        ...
        <section class="mb-5 bg-dark">
            <div class="container border-bottom py-5">
                <div class="row justify-content-center company">
                    <div class="col-12">
                        <h2 class="mb-lg-3 mb-0 display-5 fw-bold title text-center text-white">Placements & Recruiters
                        </h2>
                    </div>
        ...
        <section class="life-section pt-5 bg-gray" id="gallery">
            <div class="container ">
                ...
                <div class="row">
                    <div class="owl-carousel gallery_carousel_01 py-2">
                        ...
                        <div class="item">
                            <img src="img/events/<?= $item['image']; ?>.webp" class="gallery-img01">
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row  py-4 justify-content-center">
                    <div class="col-lg-8 mb-4 text-center">
                        <h3 class="h2 mb-0 fw-bold">Your Space to Create Starts Here.</h3>
                        <p>Join India's most prestigious Interior Design programs — where spaces become stories.</p>
