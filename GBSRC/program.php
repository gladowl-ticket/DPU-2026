    ...
    <div class="row align-items-center d-md-flex d-none">
        ...
        <div class="col-md-9 specilization_tab">
            ...
            <li class="col px-3 position-relative nav-item my-3 my-lg-0" role="presentation">
                ...
                <li class="col my-3 my-lg-0 nav-item position-relative" role="presentation">
                    <button class="nav-link red_act" id="pills-contact-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                        aria-selected="false" onclick="pgFunction()">Diploma</button>
                </li>
                ...
                <li class="col nav-item position-relative" role="presentation">
                    <button class="nav-link red_act" id="pills-phd-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false" onclick="doctorateFunction()">PhD</button>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="admission tab-content ChildTabContent d-md-block d-none" id="pills-tabContent">
                        ...
                        foreach ($ug as $tab => $data):
                            ...
                            <div class="col-md-6 col-lg-3 mb-4 d-grid">
                                <li class="nav-item d-grid px-3" role="presentation">
                                    <button class="nav-link border rounded-3 px-3 py-5 redirect-button <?= ($data['id'] === "ugTab1") ? 'active' : ''; ?>" 
                                            id="<?= $data['id']; ?>" 
                                            data-bs-toggle="pill" 
                                        ...
                                        <div class=" program_01">
                                            <div class="d-flex align-items-center">
                                                <img src="images/alard/program/ug/<?= $data['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    alt="<?= $data['course']; ?>">
                                        ...
                                        <div class="accordion-item">
                                            <h3 class="accordion-header" id="heading-<?= $data['id']; ?>-2">
                                                <button class="accordion-button collapsed" 
                                                        type="button" 
                                                        data-bs-toggle="collapse" 
                                                        data-bs-target="#collapse-<?= $data['id']; ?>-2" 
                                                        aria-expanded="false" 
                                                        aria-controls="collapse-<?= $data['id']; ?>-2">
                                                    <span class="brownTriangle"></span> Eligibility Criteria
                                                </button>
                                            </h3>
                                            <div id="collapse-<?= $data['id']; ?>-2" 
                                                class="accordion-collapse collapse" 
                                                aria-labelledby="heading-<?= $data['id']; ?>-2" 
                                                data-bs-parent="#accordion-<?= $data['id']; ?>">
                                                <div class="accordion-body">
                                                    <ul><?= $data['eligibility']; ?></ul>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="heading-<?= $data['id']; ?>-3">
                            <button class="accordion-button collapsed" 
                                    type="button" 
                                    data-bs-toggle="collapse" 
                                    data-bs-target="#collapse-<?= $data['id']; ?>-3" 
                                    aria-expanded="false" 
                                    aria-controls="collapse-<?= $data['id']; ?>-3">
                                <span class="brownTriangle"></span> Specialization
                            </button>
                        </h3>
                        <div id="collapse-<?= $data['id']; ?>-3" 
                            class="accordion-collapse collapse" 
                            aria-labelledby="heading-<?= $data['id']; ?>-3" 
                            data-bs-parent="#accordion-<?= $data['id']; ?>">
                            <div class="accordion-body">
                                <ul><?= $data['specialization']; ?></ul>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                                        ...
                                        <div class="accordion-item">
                                            <h3 class="accordion-header" id="heading-<?= $data['id']; ?>-4">
                                                <button class="accordion-button collapsed" 
                                                        type="button" 
                                                        data-bs-toggle="collapse" 
                                                        data-bs-target="#collapse-<?= $data['id']; ?>-4" 
                                                        aria-expanded="false" 
                                                        aria-controls="collapse-<?= $data['id']; ?>-4">
                                                    <span class="brownTriangle"></span> Duration
                                                </button>
                                            </h3>
                                            <div id="collapse-<?= $data['id']; ?>-4" 
                                                class="accordion-collapse collapse" 
                                ...
                                <div class="text-center">
                                    <a href="" class="btn c_btn py-2 px-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Enquire Now</a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
        ...
        <div class="row pt-5">
                <ul class="nav nav-pills mb-3" id="pills-tab-2" role="tablist">
                    ...
                    foreach ($pg as $tab => $data):
                        ...
                        <div class="col-md-6 col-lg-3 mb-4 d-grid">
                            <li class="nav-item d-grid px-3" role="presentation">
                                <button class="nav-link border rounded-3 px-3 py-5 redirect-buttonpg  <?= ($data['id'] === "pgTab1") ? 'active' : ''; ?>" 
                                        id="<?= $data['id']; ?>" 
                                        data-bs-toggle="pill" 
                                        data-bs-target="#<?= $data['targetId']; ?>" 
                                        type="button" role="tab" 
                                    ...
                                    <div class="program_01">
                                        <div class="d-flex align-items-center">
                                            <img src="images/alard/program/pg/<?= $data['imgSrc']; ?>.png" 
                                                class="icon" 
                                                loading="lazy" 
                                                alt="<?= $data['course']; ?>">
                                            <span class="mb-0 ps-3"><?= $data['course']; ?></span>
        ...
        <div class="row pt-5">
                    <ul class="nav nav-pills mb-3" id="pills-tab-3" role="tablist">
                        <?php 
                        foreach ($diploma as $tab => $data):
                            ?>
                            <div class="col-md-6 col-lg-3 mb-4 d-grid">
                                <li class="nav-item d-grid px-3" role="presentation">
                                    <button class="nav-link border rounded-3 px-3 py-5 redirect-buttondiploma  <?= ($data['id'] === "diplomaTab1") ? 'active' : ''; ?>" 
                                            id="<?= $data['id']; ?>" 
                                            data-bs-toggle="pill" 
                                            data-bs-target="#<?= $data['targetId']; ?>" 
                                            type="button" role="tab" 
                                            aria-controls="<?= $data['targetId']; ?>" 
                                            aria-selected="<?= ($data['id'] === "diplomaTab1") ? 'true' : 'false'; ?>">
                                        <div class="program_01">
                                            <div class="d-flex align-items-center">
                                                <img src="images/alard/program/diploma/<?= $data['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    alt="<?= $data['course']; ?>">
                                                <span class="mb-0 ps-3"><?= $data['course']; ?></span>
                        ...
                        endforeach; ?>
                                ...
                                <!-- Tab Content -->
                    <div id="subChildDiploma"></div>
                    <div class="tab-content" id="pills-tabContent-2">
                        <?php foreach ($diploma as $tabKey => $data) { ?>
                            <div class="tab-pane fade <?= $data['id'] === 'diplomaTab1' ? 'show active' : ''; ?>" 
                                id="<?= $data['targetId']; ?>" 
                                role="tabpanel" 
                                aria-labelledby="<?= $data['id']; ?>">
                                <!-- Content for <?= $data['course']; ?> -->
            ...
            <div class="row pt-5">
                    <ul class="nav nav-pills mb-3" id="pills-tab-4" role="tablist">
                        ...
                        foreach ($doctorate as $tab => $data):
                            ...
                            <div class="col-md-6 col-lg-3 mb-4 d-grid">
                                <li class="nav-item  d-grid px-3" role="presentation">
                                    <button class="nav-link border rounded-3 px-3 py-5 redirect-buttondoctorate <?= ($data['id'] === "doctorateTab1") ? 'active' : ''; ?>" 
                                            id="<?= $data['id']; ?>" 
                                            data-bs-toggle="pill" 
                                            data-bs-target="#<?= $data['targetId']; ?>" 
                                            type="button" role="tab" 
                                        ...
                                        <div class="program_01">
                                            <div class="d-flex align-items-center">
                                                <img src="images/alard/program/phd/<?= $data['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    alt="<?= $data['course']; ?>">
                                                <span class="mb-0 ps-3"><?= $data['course']; ?></span>
...
<?php endif; ?>
    ...
    <div class="row align-items-center d-md-none d-block">
        ...
        <div class="col-md-12 pt-3  mobilePrograms">
                        <!-- Diploma _ START -->
                        <h3 class="pb-3 pt-3">Diploma Programs</h3>
            <div class="accordion" id="accordion-containerdiplomaMobile">
                <?php foreach ($diploma as $tabKey => $tab):
                ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?= $tab['id']; ?>">
                            <button 
                                ...
                                <img src="images/alard/program/diploma/<?= $tab['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    height="40" width="40"
                                                    alt="<?= $tab['course']; ?>">
                        ...
                        <div 
                            id="collapse-<?= $tab['id']; ?>" 
                            class="accordion-collapse collapse" 
                            data-bs-parent="#accordion-containerdiplomaMobile"
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?= $tab['id']; ?>">
                            <button 
                                ...
                                <img src="images/alard/program/ug/<?= $tab['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    height="40" width="40"
                                                    alt="<?= $tab['course']; ?>">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?= $tab['id']; ?>">
                            <button 
                                ...
                                aria-expanded="false" 
                                aria-controls="collapse-<?= $tab['id']; ?>"> 
                                <img src="images/alard/program/pg/<?= $tab['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    height="40" width="40"
                                                    alt="<?= $tab['course']; ?>">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-<?= $tab['id']; ?>">
                            <button 
                                ...
                                aria-expanded="false" 
                                aria-controls="collapse-<?= $tab['id']; ?>"> 
                                <img src="images/alard/program/phd/<?= $tab['imgSrc']; ?>.png" 
                                                    class="icon" 
                                                    loading="lazy" 
                                                    height="40" width="40"
                                                    alt="<?= $tab['course']; ?>">
                        ...
                        <div 
                            id="collapse-<?= $tab['id']; ?>" 
                            class="accordion-collapse collapse" 
                            data-bs-parent="#accordion-containerDoctorateMobile"
                            aria-labelledby="heading-<?= $tab['id']; ?>">
                            <div class="accordion-body">
                                <!-- Overview -->
                                <h3>Overview</h3>
